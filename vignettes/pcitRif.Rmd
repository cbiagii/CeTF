...
Then we will associate the genes in both conditions with Gene Ontology (GO). GroupGO analysis will be performed where a set of genes are counted within all possible ontologies, without statistical power. In this example we will perform only for first condition:
