...
kable(PCIT_out$out[1:10, ]) %>% kable_styling(bootstrap_options = "striped", full_width = FALSE)

# Adjacency matrix: View(PCIT_out$adj_raw)
# Adjacency matrix with only the significant values: View(PCIT_out$adj_sig)
```
...
densitySig(mat1 = PCIT_out$adj_raw, 
           mat2 = PCIT_out$adj_sig, 
           threshold = 0.5)
```
